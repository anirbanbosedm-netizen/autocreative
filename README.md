...
Set up your profile once — name, clinic/business name, specialisation, logo, brand colors
Connect Canva — one-time integration
Fill the calendar — pick dates, select occasion type, write a title
AI generates everything automatically — branded poster image, caption, and 10 hashtags
Approve and download — one click saves the PNG to your device, ready to post
...
Go to console.anthropic.com and create an account. Copy your API key — it starts with `sk-ant-…`
2. Open the App
...
Anthropic Claude API — for caption and hashtag generation
